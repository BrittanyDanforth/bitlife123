...
function GodModeSystem:getAddictions(lifeState)
	...
	-- CRITICAL: Roblox TOS compliant - no explicit drug names
	local addictionMap = {
		alcoholic = { name = "Bad Habits", emoji = "🍺", severity = "serious" },
		alcohol_addiction = { name = "Bad Habits", emoji = "🍺", severity = "serious" },
		drug_addict = { name = "Substance Issues", emoji = "💊", severity = "critical" },
		cocaine_addiction = { name = "Substance Issues", emoji = "💊", severity = "critical" },
		heroin_addiction = { name = "Substance Issues", emoji = "💊", severity = "critical" },
		meth_addiction = { name = "Substance Issues", emoji = "💊", severity = "critical" },
		pill_addiction = { name = "Medication Issues", emoji = "💊", severity = "serious" },
		opioid_addiction = { name = "Medication Issues", emoji = "💊", severity = "critical" },
		nicotine_addict = { name = "Smoking Habit", emoji = "🚬", severity = "moderate" },
		smoking_addiction = { name = "Smoking Habit", emoji = "🚬", severity = "moderate" },
		gambling_addict = { name = "Gambling Problem", emoji = "🎰", severity = "serious" },
		gambling_addiction = { name = "Gambling Problem", emoji = "🎰", severity = "serious" },
		marijuana_addiction = { name = "Substance Issues", emoji = "🌿", severity = "moderate" },
