	...
	-- ══════════════════════════════════════════════════════════════════════════════
	{
		...
		choices = {
			...
			-- ⭐ CELEBRITY PREMIUM OPTION
			{
				...
				gamepassEmoji = "⭐",
				feedText = "⭐ Celebrity gamepass activated! Your entertainment career begins!",
				setFlags = { fame_career = true, celebrity_discovered = true },
				onResolve = function(state)
					state.FameState = state.FameState or {}
					state.FameState.isFamous = true
					state.FameState.yearsInCareer = 1
				end,
			},
		},
	},
	...
	-- ══════════════════════════════════════════════════════════════════════════════
	{
		...
		choices = {
			...
			-- 🔫 MAFIA PREMIUM OPTION
			{
				...
				requiresGamepass = "MAFIA",
				gamepassEmoji = "🔫",
				feedText = "🔫 You've joined the family. Welcome to organized crime.",
				setFlags = { in_mob = true, mafia_recruit = true },
				onResolve = function(state)
					state.MobState = state.MobState or {}
					state.MobState.inMob = true
					state.MobState.rankIndex = 1
					state.MobState.respect = 10
					state.MobState.family = "italian"
				end,
			},
	...
	-- ══════════════════════════════════════════════════════════════════════════════
	{
		...
		choices = {
			...
			-- 👑 ROYALTY PREMIUM OPTION
			{
				...
				requiresGamepass = "ROYALTY",
				gamepassEmoji = "👑",
				feedText = "👑 A ROYAL WEDDING! The whole nation watched!",
				setFlags = { married = true, has_partner = true, royal_wedding = true, is_royalty = true },
				onResolve = function(state)
					state.RoyalState = state.RoyalState or { isRoyal = true }
				end,
			},
			-- ⭐ CELEBRITY PREMIUM OPTION
			{
	...
	-- ══════════════════════════════════════════════════════════════════════════════
	{
		...
		choices = {
			...
			-- 🔫 MAFIA PREMIUM OPTION
			{
				...
				requiresGamepass = "MAFIA",
				gamepassEmoji = "🔫",
				feedText = "🔫 You chose the life. Money flows but danger follows.",
				setFlags = { in_mob = true, chose_crime_life = true },
				onResolve = function(state)
					state.MobState = state.MobState or {}
					state.MobState.inMob = true
					state.MobState.heat = (state.MobState.heat or 0) + 20
				end,
			},
			-- ⭐ CELEBRITY PREMIUM OPTION
			{
	...
	},
	{
		...
		choices = {
			...
			-- 👑 ROYALTY PREMIUM OPTION
			{
				...
				requiresGamepass = "ROYALTY",
				gamepassEmoji = "👑",
				feedText = "👑 The inheritance revealed... you're of ROYAL BLOOD!",
				setFlags = { is_royalty = true, discovered_royal_heritage = true },
				onResolve = function(state)
					state.RoyalState = state.RoyalState or {}
					state.RoyalState.isRoyal = true
					state.RoyalState.country = "uk"
					state.RoyalState.title = state.Gender == "Female" and "Duchess" or "Duke"
				end,
			},
		},
	},
