...
local EventPools = {
	...
	adult = {
		...
		},
		{
			...
			emoji = "💼",
			text = "Starting your first 'real' job in your field.",
			question = "How do you approach your new role?",
			minAge = 21, maxAge = 28,
			oneTime = true,
			choices = {
				{ text = "Work extra hard to impress", effects = { Smarts = 3, Health = -3, Money = 100 }, setFlags = { hard_worker = true }, feed = "Giving 110% to prove yourself." },
				{ text = "Good work, maintain balance", effects = { Happiness = 5, Money = 50 }, setFlags = { work_life_balance = true }, feed = "Doing well while maintaining life." },
				{ text = "Network and build relationships", effects = { Happiness = 3 }, setFlags = { networker = true }, feed = "Focused on making connections." },
				{ text = "Minimal effort, maximum coasting", effects = { Happiness = 3, Smarts = -2 }, setFlags = { slacker = true }, feed = "Doing just enough to get by." },
			},
		},
		{
		...
		},
		{
			...
			emoji = "👶",
			text = "Talking about having children.",
	...
	career = {
		...
		},
		{
			...
			emoji = "✈️",
			text = "Selected for an important business trip.",
	...
	relationships = {
		...
		},
		{
			...
			title = "Modern Dating",
			emoji = "📱",
			text = "You're trying dating apps to meet people.",
