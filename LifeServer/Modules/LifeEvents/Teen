...
TeenEvents.events = {
...

	{
		...
		minAge = 14, maxAge = 17,
		baseChance = 0.5,
		requiresStats = { Smarts = { min = 55 } }, -- Must be smart enough
		cooldown = 4,
		choices = {
			{
...

	{
		...
		baseChance = 0.5,
		cooldown = 3,
		requiresFlags = { has_best_friend = true }, -- MUST have a best friend
		choices = {
			{
				text = "Confront them",
...

	{
		...
		baseChance = 0.5,
		cooldown = 2,
		requiresStats = { Health = { min = 50 } }, -- Must be healthy enough
		choices = {
			{
				text = "Football",
