...
AdultEvents.events = {
...

	{
		...
		emoji = "💼",
		category = "career",
		text = "You've landed your first 'real' job in your field!",
		question = "How do you approach your new role?",
		minAge = 21, maxAge = 28,
		oneTime = true,
		requiresJob = true, -- Only triggers once you have a job
		choices = {
			{
...

	{
		...
		baseChance = 0.6,
		cooldown = 3,
		requiresFlags = { has_partner = true }, -- MUST have a partner
...

	{
		...
		minAge = 24, maxAge = 45,
		oneTime = true,
		requiresFlags = { committed_relationship = true, has_partner = true }, -- MUST be committed AND have partner
		requiresPartner = true,
		choices = {
			{
...

	{
		...
		minAge = 25, maxAge = 45,
		oneTime = true,
		requiresFlags = { married = true, has_partner = true }, -- MUST be married AND have partner
		requiresPartner = true,
		choices = {
			{
...

	{
		...
		baseChance = 0.5,
		cooldown = 5,
		requiresJob = true, -- MUST have a job to be at career crossroads
		choices = {
			{
...

	{
		...
		minAge = 45, maxAge = 60,
		oneTime = true,
		requiresFlags = { has_children = true }, -- MUST have children
		choices = {
			{
				text = "Sad but proud",
				effects = { Happiness = -3 },
